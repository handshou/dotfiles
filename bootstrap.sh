...
echo ""
echo "     Step 3: Start yabai service (creates plist and starts yabai):"
echo "       yabai --start-service"
echo ""
echo "     Step 4: Grant Accessibility & Screen Recording permissions:"
...
echo ""
echo "     Step 5: Generate sudoers entry (copy the ENTIRE output including username):"
...
echo ""
echo "     Step 6: Edit sudoers file and paste the FULL line:"
echo "       sudo visudo -f /private/etc/sudoers.d/yabai"
echo ""
echo "     Step 7: Restart yabai and load scripting addition:"
