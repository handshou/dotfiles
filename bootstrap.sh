...
echo "     Step 2: Privacy & Security → Accessibility"
echo "     Step 3: Click '+' → Navigate to /Applications/skhd.app"
echo "     Step 4: Toggle ON"
echo "     Step 5: Restart skhd:"
echo "       skhd --restart-service"
echo ""
echo "  3. UPDATE YABAI SUDOERS (required after every yabai update)"
echo "  ────────────────────────────────────────────────────────────"
echo ""
echo "     Step 1: Generate the sudoers entry (copy this output):"
echo "       echo \"\$(whoami) ALL=(root) NOPASSWD: sha256:\$(shasum -a 256 \$(which yabai) | cut -d ' ' -f 1) \$(which yabai) --load-sa\""
echo ""
echo "     Step 2: Edit the sudoers file:"
echo "       sudo visudo -f /private/etc/sudoers.d/yabai"
echo ""
echo "     Step 3: Replace the existing line with the new one (or add if empty)"
echo ""
echo "     Step 4: Restart yabai:"
echo "       yabai --restart-service"
echo ""
echo "     Step 5: Verify scripting addition loads:"
